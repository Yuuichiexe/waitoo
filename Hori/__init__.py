...
from Hori.confing import get_int_key, get_str_key
...
if ENV:
    ...
    from Hori.config import Development as Config
...
# Credits Logger
print(
    "[Hori] Horix Is Starting. | Programmer Network Project | BSD 2-Clause License."
)
print(
    "[Hori] Mewo Mewo! Successfully Connected With Programmer • Data Center • Chennai"
)
print(
    "[Hori] Project Maintained By: github.com/Eren-YeagerO (https://github.com/Eren-YeagerO/Hori)"
)
...
print("[Hori]: Telegraph Installing")
telegraph = Telegraph()
print("[Hori]: Telegraph Account Creating")
telegraph.create_account(short_name="Horix")
updater = tg.Updater(
    token=TOKEN,
    workers=WORKERS,
...
print("[Hori]: TELETHON CLIENT STARTING")
...
# ------------------------------------------------------------------
print("[Hori]: PYROGRAM CLIENT STARTING")
...
print(
    "[Hori]: Connecting To Programmer • Data Center • Chennai • PostgreSQL Database"
)
ubot = TelegramClient(StringSession(STRING_SESSION), API_ID, API_HASH)
print(
    "[Hori]: Connecting To Programmer • Horix Userbot (https://telegram.dog/Awesome_Hori)"
)
...
from Hori.modules.helper_funcs.handlers import (
