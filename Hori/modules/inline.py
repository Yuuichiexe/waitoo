...
from Hori.modules.helper_funcs.decorators import Horiinline
from Hori.modules.helper_funcs.miku_misc import article
from Hori.modules.sudoers import bot_sys_stats as wall
...
def inlinequery(update: Update, _) -> None:
    ...
    if (f := query.split(" ", 1)[0]) in inline_funcs:
        ...
        inline_help_dicts = [
            ...
            {
                "title": "Account info on Horix X",
                "description": "Look up a Telegram account in Miku database",
                "message_text": "Click the button below to look up a person in Horix X database using their Telegram ID",
                "thumb_urL": "https://telegra.ph/file/0bf1b29555518a0d45948.jpg",
                "keyboard": ".info ",
            },
            {
                "title": "About",
                "description": "Know about Horix X",
                "message_text": "Click the button below to get to know about Horix X.",
                "thumb_urL": "https://telegra.ph/file/0bf1b29555518a0d45948.jpg",
                "keyboard": ".about ",
            },
            {
