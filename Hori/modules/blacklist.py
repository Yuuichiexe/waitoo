...
import Hori.modules.sql.blacklist_sql as sql
from Hori import dispatcher
from Hori.modules.connection import connected
from Hori.modules.helper_funcs.alternate import send_message, typing_action
from Hori.modules.helper_funcs.anonymous import AdminPerms, user_admin
from Hori.modules.helper_funcs.chat_status import user_admin as u_admin
from Hori.modules.helper_funcs.chat_status import user_not_admin
from Hori.modules.helper_funcs.decorators import Horicmd, Horimsg
from Hori.modules.helper_funcs.extraction import extract_text
from Hori.modules.helper_funcs.misc import split_message
from Hori.modules.helper_funcs.string_handling import extract_time
from Hori.modules.log_channel import loggable
from Hori.modules.sql.approve_sql import is_approved
from Hori.modules.warns import warn

BLACKLIST_GROUP = -3


@Horicmd(command="blacklist", pass_args=True, admin_ok=True)
@u_admin
@typing_action
...
@Horicmd(command="addblacklist", pass_args=True)
...
@Horicmd(command="unblacklist", pass_args=True)
@user_admin(AdminPerms.CAN_DELETE_MESSAGES)
@typing_action
...
@Horicmd(command="blacklistmode", pass_args=True)
@loggable
...
from Hori.modules.language import gs
