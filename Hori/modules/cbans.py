...
from Hori import DEMONS, DEV_USERS, DRAGONS, LOGGER, OWNER_ID, TIGERS, WOLVES
from Hori.modules.helper_funcs.anonymous import AdminPerms, user_admin
from Hori.modules.helper_funcs.chat_status import (
    bot_admin,
    can_restrict,
    connection_status,
    is_user_admin,
...
from Hori.modules.helper_funcs.extraction import extract_user_and_text
from Hori.modules.helper_funcs.string_handling import extract_time
from Hori.modules.log_channel import gloggable, loggable


@Horicmd(command="cban", pass_args=True)
@connection_status
@bot_admin
@can_restrict
...
@Horicmd(command="tcban", pass_args=True)
@connection_status
@bot_admin
@can_restrict
@user_admin(AdminPerms.CAN_RESTRICT_MEMBERS)
...
@Horicmd(command="kick", pass_args=True)
@connection_status
@bot_admin
@can_restrict
@user_admin(AdminPerms.CAN_RESTRICT_MEMBERS)
...
@Horicmd(command="kickme", pass_args=True, filters=Filters.chat_type.groups)
@bot_admin
@can_restrict
...
@Horicmd(command="uncban", pass_args=True)
@connection_status
@bot_admin
@can_restrict
@user_admin(AdminPerms.CAN_RESTRICT_MEMBERS)
...
@Horicmd(command="selfunban", pass_args=True)
@connection_status
@bot_admin
@can_restrict
@gloggable
