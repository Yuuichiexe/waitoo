from Hori import pgram as app,TOKEN as bot_token
...
async def _reverse(_,msg):
    ...
    await text.edit(f'[{result["output"]}]({result["similar"]})', reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Chat Group", url="https://t.me/WingsOfFreedomm")]]))