...
from Hori import OWNER_ID, arq, pgram
from Hori.utils.pluginhelpers import convert_seconds_to_minutes as time_convert
from Hori.utils.pluginhelpers import fetch
...
async def inline_help_func(__HELP__):
    ...
    buttons.add(
        InlineKeyboardButton("More Help", url=f"t.me/HoriCuteBot?start=start"),
...
async def alive_function(answers):
    ...
    buttons.add(
        InlineKeyboardButton("Main Bot", url="https://t.me/HoriCuteBot"),
        InlineKeyboardButton("Go Inline", switch_inline_query_current_chat=""),
    )
...
**Profiles:** [BOT](t.me/HoriCuteBot) | [OWNER](t.me/DarlingPrince)
"""
